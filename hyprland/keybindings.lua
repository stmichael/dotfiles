...
hl.define_submap("monitor", function()
  ...
  hl.bind("h", function()
    hl.dispatch(hl.dsp.exec_cmd("workspaces --set single && notify-send 'Single monitor layout'"))
    hl.dispatch(hl.dsp.submap("reset"))
  end)
  hl.bind("t", function()
    hl.dispatch(hl.dsp.exec_cmd("workspaces --set dual && notify-send 'Dual monitor layout'"))
    hl.dispatch(hl.dsp.submap("reset"))
  end)
  hl.bind("n", function()
    hl.dispatch(hl.dsp.exec_cmd("workspaces --set presentation && notify-send 'Presentation layout'"))
    hl.dispatch(hl.dsp.submap("reset"))
  end)
end)

-- # Sound
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume -l 1.2 @DEFAULT_AUDIO_SINK@ 5%+"))
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("wpctl set-volume -l 1.2 @DEFAULT_AUDIO_SINK@ 5%-"))
...
hl.define_submap("sound", function()
  ...
  -- Volume control
  hl.bind("r", hl.dsp.exec_cmd("wpctl set-volume -l 1.2 @DEFAULT_AUDIO_SINK@ 5%+"))
  hl.bind("g", hl.dsp.exec_cmd("wpctl set-volume -l 1.2 @DEFAULT_AUDIO_SINK@ 5%-"))
