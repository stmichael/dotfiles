...
hl.define_submap("monitor", function()
  ...
  hl.bind("h", function()
    workspaces.apply_one_monitor_distribution()
    hl.dispatch(hl.dsp.submap("reset"))
  end)
  hl.bind("t", function()
    workspaces.apply_two_monitor_distribution()
    hl.dispatch(hl.dsp.submap("reset"))
  end)
  hl.bind("n", function()
    workspaces.apply_presentation_distribution()
    hl.dispatch(hl.dsp.submap("reset"))
  end)
  hl.bind("s", function()
    workspaces.apply_three_monitor_distribution()
    hl.dispatch(hl.dsp.submap("reset"))
  end)
end)
